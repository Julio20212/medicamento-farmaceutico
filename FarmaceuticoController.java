...
import com.farmacia.service.FarmaceuticoService;
...
public class FarmaceuticoController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Farmaceutico> updateFarmaceutico(@PathVariable Long id,
			@RequestBody @Valid Farmaceutico farmaceutico) {
